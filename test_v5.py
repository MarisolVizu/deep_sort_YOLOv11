...
VIDEO_OUTPUT = "output_tracking_autos_estela.mp4"  # Opcional: None para no generar
...
deepsort = DeepSort(
    ...
    min_confidence=0.02,  # ← CAMBIADO: Debe coincidir con YOLO
...
if VIDEO_OUTPUT:
    ...
    # Escala aumentada para mejor calidad
    ...
    print(f"💾 Video de salida: {VIDEO_OUTPUT} ({out_width}x{out_height})")
